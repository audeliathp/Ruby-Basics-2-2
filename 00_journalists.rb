...
puts "Il y a #{handles.length} handles dans cette array"


#Quel est le handle le plus court de cette liste ?
print "Le handle le plus court de cette liste est "
puts handles.sort_by { |word| word.length }[0]


#Combien y-a-t'il de handle contenant 5 caractères (le @ ne compte pas pour un caractère)
a = handles.find_all { |l| l.size == 6 }
print "Il y a "
print a.size 
puts " handles qui contiennent 5 caractères (hors @)."


#Combien commencent par une majuscule (première lettre juste après le @) ?
capital_letters = ('A'..'Z')
a = handles.count {|x| capital_letters.include?(x[1])}
print "IL y a "
print "#{a}"
puts " handles qui commencent par une majuscule."
...
puts "Voici la liste de handle du plus court au plus long :"
puts handles.sort_by { |word| word.length }


#Quelle est la position dans l'array de la personne @epenser ?
print "@epenser arrive en " 
position_epenser = handles.index("@epenser") + 1
print position_epenser 
puts "ème position dans la liste"
